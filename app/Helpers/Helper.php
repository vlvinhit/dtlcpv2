...
class Helper
{
    public static function qldiemdich($qldiemdichs)
    {
        $html = '';

        foreach ($qldiemdichs as $key => $qldiemdich) {
            $html .= '
                <tr>
                    <td>' . $qldiemdich->id . '</td>
                    ...
                    <td>
                        <a class="btn btn-primary btn-sm" data-toggle="modal" data-target="#editQLDiemDich' . $qldiemdich->id . '">
