...
function(e,m,n,p,q,f,g,r,t,h){function k(b){const a=new r.ShaderBuilder,{vertex:l,fragment:c}=a;p.addProjViewLocalOrigin(l,b);a.attributes.add(h.VertexAttribute.POSITION,"vec3");a.attributes.add(h.VertexAttribute.UV0,"vec2");a.varyings.add("vUV","vec2");b.hasMultipassTerrain&&a.varyings.add("depth","float");l.code.add(g.glsl`
    void main(void) {
      vUV = uv0;
