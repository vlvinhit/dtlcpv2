...
function(t,u,d,x,y,z,A,B,C,D,E,F,v,G,r,b,H,I,m,f){function w(a){const c=new H.ShaderBuilder,g=a.hasMultipassTerrain&&(a.output===d.ShaderOutput.Color||a.output===d.ShaderOutput.Alpha),{vertex:e,fragment:h,attributes:n,varyings:p}=c;v.addProjViewLocalOrigin(e,a);c.include(y.Transform,a);c.include(z.VertexColor,a);c.include(D.VisualVariables,a);a.draped?e.uniforms.add(new r.FloatPassUniform("worldToScreenRatio",(q,k)=>1/k.screenToPCSRatio)):n.add(m.VertexAttribute.BOUNDINGRECT,"mat3");n.add(m.VertexAttribute.POSITION,
...
return rayOrigin + t * rayDir;
  ...
  `);if(l=a.output===d.ShaderOutput.Depth)c.include(A.OutputDepth,a),u.addNearFar(c),u.addLinearDepth(c);e.code.add(b.glsl`
    void main(void) {
      vuv = scaledUV();
      vpos = position;
