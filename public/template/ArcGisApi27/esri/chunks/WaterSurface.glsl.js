...
function(n,w,f,h,x,y,z,A,m,B,p,C,D,E,q,k,F,r,G,t,c,H,I,u){function v(b){const a=new H.ShaderBuilder,{vertex:e,fragment:d}=a;r.addProjViewLocalOrigin(e,b);a.include(x.Transform,b);a.attributes.add(u.VertexAttribute.POSITION,"vec3");a.attributes.add(u.VertexAttribute.UV0,"vec2");const g=new G.Float4PassUniform("waterColor",l=>l.color);if(b.output===f.ShaderOutput.Color&&b.isDraped)return a.varyings.add("vpos","vec3"),e.uniforms.add(g),e.code.add(c.glsl`
        void main(void) {
