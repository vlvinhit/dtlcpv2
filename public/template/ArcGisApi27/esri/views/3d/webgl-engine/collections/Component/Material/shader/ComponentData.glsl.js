...
}`)}c.ComponentDataType=void 0;(function(a){a[a.Uniform=0]="Uniform";a[a.Varying=1]="Varying";a[a.COUNT=2]="COUNT"})(c.ComponentDataType||(c.ComponentDataType={}));const g=2**32/1E4;c.ComponentData=function(a,b){switch(b.componentData){case c.ComponentDataType.Varying:return v(a,b);case c.ComponentDataType.Uniform:return x(a);case c.ComponentDataType.COUNT:break;default:h.neverReached(b.componentData)}};c.MAX_ELEVATION_OFFSET=g;c.encodeElevationOffset=function(a,b){k.packFloatRGBA(a/g*.5+.5,b)};Object.defineProperty(c,
