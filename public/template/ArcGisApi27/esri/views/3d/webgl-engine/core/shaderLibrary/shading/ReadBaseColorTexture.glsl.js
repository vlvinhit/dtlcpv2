...
//>>built
define("exports ../ShaderOutput ../attributes/TextureCoordinateAttribute.glsl ../attributes/VertexTextureCoordinates.glsl ../util/TextureAtlasLookup.glsl ../../shaderModules/interfaces ../../shaderModules/Texture2DDrawUniform ../../../lib/basicInterfaces".split(" "),function(e,f,g,h,k,c,l,m){e.ReadBaseColorTexture=function(d,a){const b=d.fragment;!a.hasBaseColorTexture||a.output!==f.ShaderOutput.Color&&a.alphaDiscardMode===m.AlphaDiscardMode.Opaque?b.code.add(c.glsl`vec4 readBaseColorTexture() { return vec4(1.0); }`):
