...
//>>built
define(["exports","../../shaderModules/interfaces","../../shaderModules/Texture2DPassUniform","../../../lib/SSAOHelper"],function(b,c,d,e){b.EvaluateAmbientOcclusion=function(a,f){a=a.fragment;f.receiveAmbientOcclusion?(a.uniforms.add(new d.Texture2DPassUniform("ssaoTex",(h,g)=>g.ssaoHelper.colorTexture)),a.constants.add("blurSizePixelsInverse","float",1/e.blurSizePixels),a.code.add(c.glsl`float evaluateAmbientOcclusionInverse() {
